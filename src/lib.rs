...
fn draw_triangle(
    ...
    context.begin_path();
    context.line_to(left.0, left.1); // bottom left of triangle       左下の頂点
    context.line_to(right.0, left.1); // bottom left of triangle       左下の頂点
    context.line_to(top.0, top.1); // bottom left of triangle       左下の頂点
    context.close_path();
    context.stroke();
    context.fill();
}
